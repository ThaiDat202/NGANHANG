    ...
    public partial class NGANHANGDataSet : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.relationFK_GD_CHUYENTIEN_NhanVien1 = new global::System.Data.DataRelation("FK_GD_CHUYENTIEN_NhanVien1", new global::System.Data.DataColumn[] {
                        this.tableDS0Login.MANVColumn}, new global::System.Data.DataColumn[] {
                        this.tableGD_CHUYENTIEN.MANVColumn}, false);
        ...
        public partial class GD_CHUYENTIENRow : global::System.Data.DataRow {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public DS0LoginRow DS0LoginRow {
                get {
                    return ((DS0LoginRow)(this.GetParentRow(this.Table.ParentRelations["FK_GD_CHUYENTIEN_NhanVien1"])));
                }
                set {
        ...
        public partial class GD_GOIRUTRow : global::System.Data.DataRow {
            ...
            public DS0LoginRow DS0LoginRow {
                get {
                    return ((DS0LoginRow)(this.GetParentRow(this.Table.ParentRelations["FK_GD_GOIRUT_NhanVien1"])));
                }
                set {
...
SELECT SOTK, CMND, SODU, MACN, NGAYMOTK FROM TaiKhoan WHERE (SOTK = @SOTK)";
    ...
    public partial class InfoFromTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT SOTK, TaiKhoan.CMND, HOTEN = HO + \' \' + TEN\r\nFROM TaiKhoan INNER JOIN LINK" +
                "0.NGANHANG.DBO.KhachHang ON TaiKhoan.CMND = KhachHang.CMND";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
